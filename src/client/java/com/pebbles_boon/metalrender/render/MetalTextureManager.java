...
public class MetalTextureManager {
  private static final Identifier BLOCKS_ATLAS_ID = Identifier.fromNamespaceAndPath("minecraft", "textures/atlas/blocks.png");
  ...
  public void loadBlockAtlas() {
    try {
      ...
      if (texView instanceof GpuTextureView view && view.texture() instanceof GlTexture glTex) {
        glTexId = glTex.glId();
      }
      if (glTexId == 0) {
